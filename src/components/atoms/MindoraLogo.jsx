    ...
    <svg width={size} height={size} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <radialGradient id="ml-petal-pink" cx="50%" cy="22%" r="78%">
          ...
          <stop offset="100%" stopColor="#1e4e79" />
        </radialGradient>
        ...
        <filter id="ml-petal-glow" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="0" stdDeviation="2.5" floodColor="#6fa3d0" floodOpacity="0.4" />
        </filter>

        <filter id="ml-img-shadow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="1.5" stdDeviation="2" floodColor="#123152" floodOpacity="0.35" />
        </filter>
